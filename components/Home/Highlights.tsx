...
const Highlights: React.FC = () => {
  return (
    <section className="relative py-24 bg-gradient-to-b from-blue-50/50 via-white to-orange-50/30 overflow-hidden">
      ...
      <div className="absolute -top-20 -left-20 w-72 h-72 bg-purple-200/60 rounded-full blur-3xl pointer-events-none animate-blob"></div>
      <div className="absolute -top-20 -right-20 w-80 h-80 bg-cyan-200/60 rounded-full blur-3xl pointer-events-none animate-blob animation-delay-2000"></div>
      <div className="absolute -bottom-20 -left-20 w-96 h-96 bg-yellow-200/60 rounded-full blur-3xl pointer-events-none animate-blob animation-delay-4000"></div>
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-lime-200/60 rounded-full blur-3xl pointer-events-none animate-blob animation-delay-4000"></div>
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-80 h-80 bg-fuchsia-200/60 rounded-full blur-3xl pointer-events-none animate-blob"></div>
