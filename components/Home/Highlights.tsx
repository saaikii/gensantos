...
const Highlights: React.FC = () => {
  return (
    <section className="relative py-24 bg-gradient-to-b from-blue-50/50 via-white to-orange-50/30 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-72 h-72 bg-blue-300/40 rounded-full blur-[100px] pointer-events-none mix-blend-multiply animate-blob animation-delay-2000"></div>
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-400/40 rounded-full blur-[100px] pointer-events-none mix-blend-multiply animate-blob"></div>
      <div className="absolute bottom-0 left-20 w-80 h-80 bg-blue-300/40 rounded-full blur-[100px] pointer-events-none mix-blend-multiply animate-blob animation-delay-4000"></div>
      <div className="absolute bottom-0 right-20 w-80 h-80 bg-blue-500/40 rounded-full blur-[100px] pointer-events-none mix-blend-multiply animate-blob animation-delay-2000"></div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-400/40 rounded-full blur-[100px] pointer-events-none mix-blend-multiply animate-blob animation-delay-4000"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <ScrollReveal className="animate-fade-in-up">
            ...
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight text-slate-900">
              ...
              <span className="text-yellow-400">Economic Growth</span>
            </h2>
