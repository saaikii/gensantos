...
const TransparencyBoard: React.FC<TransparencyBoardProps> = ({ onNavigate }) => {
  ...
  return (
    <section className="relative py-24 bg-slate-50 overflow-hidden">
      ...
      <div className="absolute -top-20 -left-20 w-80 h-80 bg-green-200/60 rounded-full blur-3xl pointer-events-none animate-blob animation-delay-2000"></div>
      <div className="absolute -top-20 -right-20 w-96 h-96 bg-blue-200/60 rounded-full blur-3xl pointer-events-none animate-blob"></div>
      <div className="absolute -bottom-20 -left-20 w-72 h-72 bg-yellow-200/60 rounded-full blur-3xl pointer-events-none animate-blob animation-delay-4000"></div>
      <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-orange-200/60 rounded-full blur-3xl pointer-events-none animate-blob animation-delay-2000"></div>
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-indigo-200/60 rounded-full blur-3xl pointer-events-none animate-blob animation-delay-4000"></div>
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-80 h-80 bg-teal-200/60 rounded-full blur-3xl pointer-events-none animate-blob"></div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-pink-200/40 rounded-full blur-3xl pointer-events-none animate-blob"></div>
