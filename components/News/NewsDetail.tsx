                    ...
                    <div className="space-y-6">
                      ...
                      <div className="p-6 bg-blue-50 border-l-4 border-blue-600 rounded-r-xl">
                        <p className="text-blue-800 font-medium italic">
                          This is the complete report for this {newsItem.category.toLowerCase()}. For more information, please contact the City Public Information Office.
                        </p>
                      </div>
                    </div>
                  )}
