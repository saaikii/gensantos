...
import { 
  ...
  Medal, GraduationCap, HeartPulse, Coins, Trash2, Book
} from 'lucide-react';
...
export const services = [
    { id: 'svc-1', name: "LGU-GENSAN Citizen’s Charter 2025-1st Edition (FULL)", link: "https://gensantos.gov.ph/general-santos-city/citizens-charter/lgu-gensan-citizens-charter-2025-1st-edition/", icon: <BookOpen />, type: 'service' as const, description: "Official 2025 iteration of GenSan's Citizen's Charter.", category: 'executive' },
    ...
    { id: 'svc-7', name: "City Economic Management & Cooperative Dev't", link: "https://drive.google.com/file/d/1EU7WdH9UFcxfyfIT7i01wz1XxP5Ht6PL/view?usp=sharing", icon: <Briefcase />, type: 'service' as const, description: "Economic development plan guides.", category: 'services' },
    ...
    { id: 'svc-9', name: "City Environment & Natural Resources", link: "https://drive.google.com/file/d/1uIatx_ga_Suk1Ib5SNKsfDqZxt6U6Ry3/view?usp=sharing", icon: <Leaf />, type: 'service' as const, description: "Environment protection guides.", category: 'services' },
    ...
    { id: 'svc-12', name: "City Internal Audit Services", link: "https://drive.google.com/file/d/1FqCvdkUB0XXOjAI_k9yteHygxuuqJTCS/view?usp=sharing", icon: <FileText />, type: 'service' as const, description: "Audit service guides.", category: 'executive' },
    ...
    { id: 'svc-17', name: "CMO - Integrated Barangay Affairs", link: "https://drive.google.com/file/d/1FTvhI6R3nRDcZW2jo_7bJduQ30GPAc2i/view?usp=sharing", icon: <Users />, type: 'service' as const, description: "Barangay affairs guides.", category: 'executive' },
    ...
    { id: 'svc-20', name: "CMO - Business Permits & Licenses", link: "https://drive.google.com/file/d/14nWcQyUUKpN2CfceE3x6DLgTn1gE_hag/view?usp=sharing", icon: <FileText />, type: 'service' as const, description: "Business licensing guides.", category: 'services' },
    ...
    { id: 'svc-25', name: "City Planning & Development", link: "https://drive.google.com/file/d/1mzmXvR9bv8ysYQ6ofzJvLGr4e10AGsVq/view?usp=sharing", icon: <LandPlot />, type: 'service' as const, description: "Comprehensive development guides.", category: 'executive' },
    ...
    { id: 'svc-28', name: "City Treasurer’s Office", link: "https://drive.google.com/file/d/1R3-MRAhLXqd9xHVwhBwR6ot41Z9irCyv/view?usp=sharing", icon: <Coins />, type: 'service' as const, description: "Tax collection guides.", category: 'finance' },
    ...
    { id: 'svc-30', name: "City Health Office", link: "https://drive.google.com/file/d/1m5-uFFtHnq5p45VY3_0fjShiRGU6jcW9/view?usp=sharing", icon: <HeartPulse />, type: 'service' as const, description: "Medical assistance guides.", category: 'social' },
    { id: 'svc-31', name: "Dr. Jorge P. Royeca City Hospital", link: "https://drive.google.com/file/d/1Tv2V976N0l9RVoFArS_5BeeQKUs0mYIm/view?usp=sharing", icon: <Building2 />, type: 'service' as const, description: "Tertiary hospital guides.", category: 'social' },
    ...
    { id: 'svc-33', name: "Local Civil Registrar", link: "https://drive.google.com/file/d/1vA2EhGdrSPQ8WIRCw6hBqCcxDx-IIejN/view?usp=sharing", icon: <FileText />, type: 'service' as const, description: "Civil registration guides.", category: 'services' },
    { id: 'svc-34', name: "Office of the Building Official", link: "https://drive.google.com/file/d/1duBFBv1qPvqGWGjdO_hk0sA09c4IrQvE/view?usp=sharing", icon: <Building2 />, type: 'service' as const, description: "Construction regulation guides.", category: 'services' },
...
export const newsItems = [
    { id: 'news-1', name: "New Digital Hub for Tech Startups Opens Downtown", category: "News", date: "August 12, 2024", image: "https://picsum.photos/id/48/800/600", description: "Mayor Lorelie Pacquiao inaugurates the new Innovation Center designed to support local tech entrepreneurs and students.", type: 'news' as const },
    { id: 'news-2', name: "City Health Office Launches Mobile Vaccination Drive", category: "News", date: "August 10, 2024", image: "https://picsum.photos/id/338/800/600", description: "Bringing healthcare closer to barangays, the new mobile clinic will offer free vaccinations and check-ups starting next week.", type: 'news' as const },
    { id: 'news-3', name: "LGU Receives Award for Good Governance", category: "News", date: "August 05, 2024", image: "https://picsum.photos/id/400/800/600", description: "General Santos City recognized as one of the most competitive cities in Mindanao during the recent summit.", type: 'news' as const },
    { id: 'ann-1', name: "Suspension of Classes on August 21", category: "Announcement", date: "August 18, 2024", image: "https://picsum.photos/id/175/800/600", description: "Classes in all levels, both public and private, are suspended in observance of Ninoy Aquino Day.", type: 'announcement' as const },
    { id: 'ann-2', name: "Business Tax Payment Deadline Extended", category: "Announcement", date: "August 15, 2024", image: "https://picsum.photos/id/20/800/600", description: "The City Treasurer's Office announces the extension of the deadline for the 3rd quarter business tax payment.", type: 'announcement' as const },
    { id: 'ann-3', name: "Road Closure Advisory: Pioneer Avenue", category: "Announcement", date: "August 14, 2024", image: "https://picsum.photos/id/1076/800/600", description: "Please be advised of the temporary road closure at Pioneer Avenue for road widening projects starting next week.", type: 'announcement' as const },
    { id: 'act-1', name: "GenSan Prepares for Annual Tuna Festival 2024", category: "Activities", date: "August 15, 2024", image: "https://picsum.photos/id/400/800/600", description: "The city government announces the schedule of activities for the upcoming Tuna Festival.", type: 'activity' as const },
    { id: 'act-2', name: "Sunday Zumba at the Oval Plaza", category: "Activities", date: "Every Sunday", image: "https://picsum.photos/id/342/800/600", description: "Join the weekly community fitness program every Sunday morning at the Oval Plaza.", type: 'activity' as const },
    { id: 'act-3', name: "Barangay Basketball League Finals", category: "Activities", date: "August 25, 2024", image: "https://picsum.photos/id/453/800/600", description: "Witness the championship match between Brgy. Lagao and Brgy. Calumpang this coming weekend.", type: 'activity' as const }
];
