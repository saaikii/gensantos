...
export const newsItems = [
  ...
  { id: 'ann-2', title: "Business Tax Payment Deadline Extended", category: "Announcement", date: "January 15, 2026", image: "/images/city_hall_bg.png", summary: "The City Treasurer's Office announces the extension of the deadline for the 1st quarter business tax payment.", type: 'announcement' as const },
  { id: 'ann-3', title: "Road Closure Advisory: Pioneer Avenue", category: "Announcement", date: "January 14, 2026", image: "/images/city_plaza_bg.png", summary: "Please be advised of the temporary road closure at Pioneer Avenue for road widening projects starting next week.", type: 'announcement' as const },
  ...
  { id: 'act-2', title: "Sunday Zumba at the Oval Plaza", category: "Activities", date: "Every Sunday", image: "", summary: "Join the weekly community fitness program every Sunday morning at the Oval Plaza.", type: 'activity' as const },
  { id: 'act-3', title: "Inter-Barangay Basketball League Finals", category: "Activities", date: "January 20, 2026", image: "", summary: "Championship match between Brgy. Lagao and Brgy. Calumpang at the City Gym.", type: 'activity' as const },
];
