...
export const newsItems = [
  { id: 'news-1', name: "New Digital Hub for Tech Startups Opens Downtown", category: "News", date: "January 12, 2026", image: "/images/news_lgu_oversight.png", description: "Mayor Lorelie Pacquiao inaugurates the new Innovation Center designed to support local tech entrepreneurs and students.", type: 'news' as const },
  { id: 'news-2', name: "City Health Office Launches Mobile Vaccination Drive", category: "News", date: "January 10, 2026", image: "/images/emergency_bg.png", description: "Bringing healthcare closer to barangays, the new mobile clinic will offer free vaccinations and check-ups starting next week.", type: 'news' as const },
  ...
  { id: 'ann-1', name: "Suspension of Classes on January 21", category: "Announcement", date: "January 18, 2026", image: "/images/announcement.jpg", description: "Classes in all levels, both public and private, are suspended in observance of local holiday.", type: 'announcement' as const },
  { id: 'ann-2', name: "Business Tax Payment Deadline Extended", category: "Announcement", date: "January 15, 2026", image: "/images/city_hall_bg.png", description: "The City Treasurer's Office announces the extension of the deadline for the 1st quarter business tax payment.", type: 'announcement' as const },
  { id: 'ann-3', name: "Road Closure Advisory: Pioneer Avenue", category: "Announcement", date: "January 14, 2026", image: "/images/city_plaza_bg.png", description: "Please be advised of the temporary road closure at Pioneer Avenue for road widening projects starting next week.", type: 'announcement' as const },
  { id: 'act-1', name: "GenSan Prepares for Kalilangan Festival 2026", category: "Activities", date: "January 15, 2026", image: "/images/activities_tab_bg.jpg", description: "The city government announces the schedule of activities for the upcoming Kalilangan Festival.", type: 'activity' as const },
  { id: 'act-2', name: "Sunday Zumba at the Oval Plaza", category: "Activities", date: "Every Sunday", image: "/images/hero_batang_pinoy.png", description: "Join the weekly community fitness program every Sunday morning at the Oval Plaza.", type: 'activity' as const },
  { id: 'act-3', name: "Inter-Barangay Basketball League Finals", category: "Activities", date: "January 20, 2026", image: "/images/batang_pinoy_qr.jpg", description: "Championship match between Brgy. Lagao and Brgy. Calumpang at the City Gym.", type: 'activity' as const },
];
