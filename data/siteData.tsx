...
export const newsItems = [
  { id: 'news-1', name: "Ribbon Cutting & Turnover Ceremony", category: "News", date: "December 09, 2025", image: "/images/news_ribbon_cutting.jpg", description: "Mayor Lorelie Pacquiao leads the Ribbon Cutting and Turnover ceremony with the theme 'From Hands that Built to Hearts that Serve: The Turnover of MEBA's Legacy'.", type: 'news' as const },
  { id: 'news-2', name: "LGU Institutionalizes Oversight on National Projects", category: "News", date: "January 20, 2026", image: "/images/news_lgu_oversight.png", description: "GENERAL SANTOS CITY — National government agencies will soon be required to closely coordinate with the city government before implementing nationally funded projects, as the City Council moves to institutionalize stronger oversight and information-sharing on major developments within the city.", type: 'news' as const },
  ...
  { id: 'ann-1', name: "READ | EXECUTIVE ORDER NO. 72, S. 2026", category: "Announcement", date: "January 16, 2026", image: "/images/announcement.jpg", description: "EXECUTIVE ORDER DECLARING SUSPENSION OF CLASSES AT ALL LEVELS IN PUBLIC AND PRIVATE SCHOOLS AND SUSPENSION OF WORK IN GOVERNMENT OFFICES WTTHIN GENERAL SANTOS CITY ON JANUARY 16, 2026, IN OBSERVANCE OF ISRA WAL MIRAJ (THE NOCTURNAL JOURNEY AND ASCENSION OF PROPHET MUHAMMAD, S.A.W)", type: 'announcement' as const },
