...
export const newsItems = [
  { id: 'news-1', name: "New Digital Hub for Tech Startups Opens Downtown", category: "News", date: "January 12, 2026", image: "https://picsum.photos/id/48/800/600", description: "Mayor Lorelie Pacquiao inaugurates the new Innovation Center designed to support local tech entrepreneurs and students.", type: 'news' as const },
  { id: 'news-2', name: "City Health Office Launches Mobile Vaccination Drive", category: "News", date: "January 10, 2026", image: "https://picsum.photos/id/338/800/600", description: "Bringing healthcare closer to barangays, the new mobile clinic will offer free vaccinations and check-ups starting next week.", type: 'news' as const },
  { id: 'news-3', name: "428 families in Gensan get food assistance from DSWD’s Walang Gutom Program 2026", category: "News", date: "January 21, 2026", image: "/images/news_good_governance.jpg", description: "GENERAL SANTOS CITY (PIA) — A total of 428 families from different barangays in General Santos City have become the first beneficiaries of the Walang Gutom Program for this year, which was recently launched by the Department of Social Welfare and Development (DSWD) in the city.", type: 'news' as const },
  { id: 'ann-1', name: "Suspension of Classes on January 21", category: "Announcement", date: "January 18, 2026", image: "https://picsum.photos/id/175/800/600", description: "Classes in all levels, both public and private, are suspended in observance of local holiday.", type: 'announcement' as const },
  { id: 'ann-2', name: "Business Tax Payment Deadline Extended", category: "Announcement", date: "January 15, 2026", image: "https://picsum.photos/id/20/800/600", description: "The City Treasurer's Office announces the extension of the deadline for the 1st quarter business tax payment.", type: 'announcement' as const },
  { id: 'ann-3', name: "Road Closure Advisory: Pioneer Avenue", category: "Announcement", date: "January 14, 2026", image: "https://picsum.photos/id/1076/800/600", description: "Please be advised of the temporary road closure at Pioneer Avenue for road widening projects starting next week.", type: 'announcement' as const },
  { id: 'act-1', name: "GenSan Prepares for Kalilangan Festival 2026", category: "Activities", date: "January 15, 2026", image: "https://picsum.photos/id/400/800/600", description: "The city government announces the schedule of activities for the upcoming Kalilangan Festival.", type: 'activity' as const },
  ...
  { id: 'act-3', name: "Barangay Basketball League Finals", category: "Activities", date: "January 25, 2026", image: "https://picsum.photos/id/453/800/600", description: "Witness the championship match between Brgy. Lagao and Brgy. Calumpang this coming weekend.", type: 'activity' as const }
];
